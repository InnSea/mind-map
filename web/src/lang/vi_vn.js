export default {
  ...
  export: {
    ...
    addFooterTextPlaceholder: 'Ví dụ: Test case mind map',
  ...
  toolbar: {
    ...
    save: 'Lưu',
    share: 'Chia sẻ',
    shareSuccess: 'Liên kết chia sẻ đã được sao chép vào bộ nhớ tạm',
  ...
  edit: {
    ...
    shareNoCooperateTip: 'Trang xem trước không hỗ trợ chỉnh sửa cộng tác',
