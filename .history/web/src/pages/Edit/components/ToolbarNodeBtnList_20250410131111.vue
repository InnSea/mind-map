<template>
  <div class="toolbarNodeBtnList" :class="[dir, { isDark: isDark }]">
    <template v-for="(item, index) in list" :key="index">
      ...
      <div v-if="item === 'painter'" class="toolbarBtn" :class="{
      ...
      <div v-if="item === 'icon'" class="toolbarBtn" :class="{
        disabled: activeNodes.length <= 0
      }" @click="showNodeIcon">
      ...
      <div v-if="item === 'associativeLine'" class="toolbarBtn" :class="{
        disabled: activeNodes.length <= 0 || hasGeneralization
      ...
      <div>
        <NodeAnnotationBtn v-if="item === 'annotation' && supportMark" :isDark="isDark" :dir="dir"
          :rightHasBtn="annotationRightHasBtn" @setAnnotation="onSetAnnotation"></NodeAnnotationBtn>
      </div>
    </template>
  </div>
</template>
