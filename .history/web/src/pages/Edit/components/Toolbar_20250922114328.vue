<template>
  <div class="toolbarContainer" :class="{ isDark: isDark }">
    <!-- 收起/展开按钮 -->
    <div class="toolbarToggle" @click="toggleToolbar" :class="{ collapsed: !toolbarExpanded }">
      <span class="icon iconfont" :class="toolbarExpanded ? 'el-icon-arrow-up' : 'el-icon-arrow-down'"></span>
    </div>
    <div class="toolbar" ref="toolbarRef" :class="{ collapsed: !toolbarExpanded }">
      <!-- 节点操作 -->
