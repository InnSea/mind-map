...
export default {
  ...
  methods: {
      ...
      this.aiInstance.request(
        ...
        content => {
          ...
          console.log('AI生成结束', {
            ...
            hasContent: !!this.aiCreatingContent
          })
          // 确保触发最终渲染
          this.loopRenderOnAiCreating()
        },
    ...
    loopRenderOnAiCreatingPart() {
      ...
      // 在当前渲染完成时再进行下一次渲染
      const onRenderEnd = () => {
        console.log('续写 onRenderEnd 被调用', {
          isAiCreating: this.isAiCreating,
          hasContent: !!this.aiCreatingContent
        })
