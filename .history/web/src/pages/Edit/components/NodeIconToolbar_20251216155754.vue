...
export default {
  ...
  data() {
    return {
      ...
      nodeIconList: [],
      iconList: [],
      nodeIconList: mergerIconList([..._nodeIconList, ...this.dynamicIconList, ...icon]),
    }
  },
  computed: {
    ...mapState({
    ...
    allIconList() {
      return mergerIconList([..._nodeIconList, ...this.dynamicIconList, ...icon])
    }
  },
  created() {
