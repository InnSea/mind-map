...
export default {
    ...
    computed: {
        ...
        allIconList() {
            console.log([..._nodeIconList, ...icon, ...this.dynamicIconList]);
            return [..._nodeIconList, ...icon, ...this.dynamicIconList]
        }
    },
    created() {
    ...
    methods: {
        ...
        show(node, icon) {
            ...
            const found = this.allIconList.find((item) => {
                return item.type === this.iconType
            })
            this.iconList = found ? [...found.list] : []
            this.updatePos()
