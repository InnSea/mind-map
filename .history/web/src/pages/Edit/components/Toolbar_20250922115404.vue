<template>
  <div class="toolbarContainer" :class="{ isDark: isDark, collapsed: !toolbarExpanded }">
    <!-- 收起/展开按钮 -->
    <div class="toolbarToggleBtn" :class="{ collapsed: !toolbarExpanded }" @click="toggleToolbar">
      <span class="iconfont" :class="toolbarExpanded ? 'iconshangyi' : 'iconxiayi'"></span>
    </div>
    <div class="toolbar" ref="toolbarRef">
      ...
      <!-- 导出 -->
      <div class="toolbarBlock">
        <div class="toolbarBtn" @click="$bus.$emit('showImport')" v-if="!isPublic">
      ...
      <!-- 收起/展开按钮 -->
      <div class="toolbarToggle" @click="toggleToolbar">
        <span class="icon iconfont" :class="toolbarExpanded ? 'iconshangyi' : 'iconxiayi'"></span>
      </div>
    </div>
    <NodeImage></NodeImage>
