  ...
  methods: {
    ...
    init() {
      ...
      this.mindMap = new MindMap({
        ...
        ...(config || {}),
        icon.avatarList.push(
          {
            name: '用户头像', // 分组名称
            type: 'user_avatar', // 分组的值
            list: [
              {
                name: 'test-avatar', // 图标名称
                icon: 'https://huomiao-app.oss-cn-beijing.aliyuncs.com/mindmap/01a24316-ab27-4a28-a434-231cbe7dc506.png' // 图标，可以传svg或图片
              }
            ]
          }
        )
