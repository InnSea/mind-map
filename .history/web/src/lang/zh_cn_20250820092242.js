export default {
  ...
  export: {
    ...
    addFooterTextPlaceholder: '比如：测试用例dao',
    desc: '说明',
    options: '选项',
  ...
  ai: {
    ...
    aiCreatePartMsgPrefix: '现在你是一个思维导图辅助工具，这是一个现有的思维导图的根节点内容：',
    aiCreatePartMsgCenter: '，我需要你帮我扩展',
    aiCreatePartMsgPostfix: '这个子节点的内容，生成它的子节点，格式为markdown格式列表，每个子节点可以包含更深层的子节点。',
    aiCreatePartMsgHelp: '注意：请不要重复原有节点的内容，只生成新的子节点内容。'
  },
  note: {
    title: '备注'
  },
