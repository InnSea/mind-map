export default {
  ...
  ai: {
    ...
    stopGenerating: '停止生成',
    createMindMapTitle: 'AI一键生成思维导图',
    createTip: '请详细描述你的需求，AI将根据你的描述生成思维导图',
    importantTip: '重要提示：AI功能需要本地客户端，点击下方链接进行下载',
    baiduNetdisk: '百度网盘',
    connectFailedTitle: '客户端连接失败',
    connectFailedTip: '检查客户端是否正常启动：',
    connectFailedCheckTip1: '1.是否已下载客户端（',
    connectFailedCheckTip2: '2.是否解压并运行客户端程序',
    connectFailedCheckTip3: '3.是否配置了正确的AI服务商信息',
    connectFailedCheckTip4: '4.网络连接是否正常',
    connectionDetection: '连接检测',
    connectSuccessful: '连接成功',
    connectFailed: '连接失败',
    configurationMissing: '配置缺失',
    wantModifyAiConfigTip: '想要修改AI配置？',
    modifyAIConfiguration: '修改AI配置',
    noInputTip: '请输入内容',
    aiCreatePart: 'AI续写',
    aiCreateMsgPrefix: '现在你是一个思维导图辅助工具，我需要你帮我梳理一个主题，生成的思维导图结构要清晰，用markdown格式输出，包含主标题、二级标题、三级标题等，可以加粗重要的关键词，主题是：',
    aiCreateMsgPostfix: '，请帮我梳理。',
    aiCreatePartDefaultInput: '帮我续写这个节点',
    aiCreatePartPlaceholder: '可修改：输入你的要求，如"重点关注技术细节"、"生成3-5个子节点"等',
    currentNode: '当前节点',
    pathInfo: '思维导图路径：',
    currentNodeInfo: '需要续写的节点：',
    siblingsInfo: '同级节点有：',
    existingChildrenInfo: '该节点已有子节点：',
    userInstructionInfo: '补充要求：',
    aiCreatePartPromptPrefix: '你是一个思维导图续写助手。请根据以下上下文信息，为指定节点生成子节点内容。',
    aiCreatePartPromptSuffix: '请生成该节点的子节点，要求：\n1. 格式为markdown列表，每个子节点可包含更深层的子节点\n2. 不要重复已有的子节点内容\n3. 内容要与同级节点的风格和层次保持一致\n4. 结构清晰，逻辑合理'
  },
  note: {
    title: '备注'
  },
