function generateAvatarSvg(name, color) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
      ...
      <text x="50" y="50" font-family="Arial, sans-serif" font-size="56" font-weight="bold" fill="#fff" text-anchor="middle" dominant-baseline="central">${displayName}</text>
    </svg>`
}
...
loadUserIconList().then(res => console.log(res))
